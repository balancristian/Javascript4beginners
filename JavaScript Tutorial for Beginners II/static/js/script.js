...
// Challange 2: GenerateCat
function generateCat(){
    var image = document.createElement('img');
    var div = document.getElementById('flex-cat-gen');
    image.src="https://www.icegif.com/wp-content/uploads/cat-icegif-16.gif";
    div.appendChild(image);
}

// Challege 3: Rock, Papper, Scissors
...
function rpsFrondEnd(humanImageChoice, botImageChoice, finalMessage){
    ...
    humanDiv.innerHTML = "<img src='" + imagesDatabase[humanImageChoice] + "' height=150 with=150 style='box-shadow: 0px 10px 50px rgba(37, 50, 233, 1);'>";
    messageDiv.innerHTML = "<h1 style='color: " +finalMessage['color'] + "; font-size: 60px; padding: 30px; '>" + finalMessage['message'] + "</h1>";
    botDiv.innerHTML = "<img src='" + imagesDatabase[botImageChoice] + "' height=150 with=150 style='box-shadow: 0px 10px 50px rgba(243, 38, 24, 1);'>";
...
const lossSount = new Audio('static/sounds/aww.mp3');
